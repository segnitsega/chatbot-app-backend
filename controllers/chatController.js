...
// // Grok API Key
// const GROK_API_KEY = 'your-grok-api-key'; // Use the actual key
...
//       'https://api.grok.com/v1/chat', // Replace with the actual Grok API endpoint
//       {
...
//   } catch (error) {
//     console.error('Error interacting with Grok API:', error);
